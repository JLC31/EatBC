...
class StuMenu extends StatefulWidget {
  @override
  _StuMenuState createState() => _StuMenuState();
}

class _StuMenuState extends State<StuMenu> {
  ...
  void getstuItems() {
    ...
    {
      if (data[i]['Location_Name'] == 'Stuart Hall') {
        meals.add(data[i]['Meal_Name']);
      }
      if (data[i]['Location_Name'] == 'Stuart Hall' && data[i]['Meal_Name'] == 'BREAKFAST' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)')
      {
        stuBItems.add(data[i]['Recipe_Print_As_Name']);
        stuBFacts.add(data[i]);
      }
      else if (data[i]['Location_Name'] == 'Stuart Hall' && data[i]['Meal_Name'] == 'LUNCH' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)'){
        stuLItems.add(data[i]['Recipe_Print_As_Name']);
        stuLFacts.add(data[i]);
      }
      else if (data[i]['Location_Name'] == 'Stuart Hall' && data[i]['Meal_Name'] == 'DINNER' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)'){
        stuDItems.add(data[i]['Recipe_Print_As_Name']);
        stuDFacts.add(data[i]);
      }
      else if (data[i]['Location_Name'] == 'Stuart Hall' && data[i]['Meal_Name'] == 'LATE NIGHT' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)'){
        stuLNItems.add(data[i]['Recipe_Print_As_Name']);
        stuLNFacts.add(data[i]);
      }
  ...
  //List mealName = ['Breakfast', 'Lunch', 'Dinner'];
  
  
  @override
  Widget build(BuildContext context) {
    List mealItems = [stuBMenu, stuLMenu, stuDMenu, stuLNMenu];
    String mealName = '';
