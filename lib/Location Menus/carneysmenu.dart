...
class CarneysMenu extends StatefulWidget {
  @override
  _CarneysMenuState createState() => _CarneysMenuState();
}

class _CarneysMenuState extends State<CarneysMenu> {
  ...
  void getCarneysItems() {
    ...
    {
      if (data[i]['Location_Name'] == "Carney's ") {
        meals.add(data[i]['Meal_Name']);
      }
      if (data[i]['Location_Name'] == "Carney's " && data[i]['Meal_Name'] == 'BREAKFAST' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)')
      {
        carneysBItems.add(data[i]['Recipe_Print_As_Name']);
        carneysBFacts.add(data[i]);
      }
      else if (data[i]['Location_Name'] == "Carney's " && data[i]['Meal_Name'] == 'LUNCH' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)'){
        carneysLItems.add(data[i]['Recipe_Print_As_Name']);
        carneysLFacts.add(data[i]);
      }
      else if (data[i]['Location_Name'] == "Carney's " && data[i]['Meal_Name'] == 'DINNER' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)'){
        carneysDItems.add(data[i]['Recipe_Print_As_Name']);
        carneysDFacts.add(data[i]);
      }
      else if (data[i]['Location_Name'] == "Carney's " && data[i]['Meal_Name'] == 'LATE NIGHT' && data[i]['Menu_Category_Name'] != 'GET Offerings (as available)'){
        carneysLNItems.add(data[i]['Recipe_Print_As_Name']);
        carneysLNFacts.add(data[i]);
      }

    }

    setState(() {
      carneysBMenu = carneysBItems;
      carneysLMenu = carneysLItems;
      carneysDMenu = carneysDItems;
      carneysLNMenu = carneysLNItems;

      carneysBNut = carneysBFacts;
      carneysLNut = carneysLFacts;
      carneysDNut = carneysDFacts;
      carneysLNNut = carneysLNFacts;
  ...
  Widget build(BuildContext context) {
    List mealItems = [carneysBMenu, carneysLMenu, carneysDMenu, carneysLNMenu];
    String mealName = '';
